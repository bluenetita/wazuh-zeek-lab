...
# ReverseShellCustom
@load custom_scripts/reverse_shell/reverse_shell.zeek
@load custom_scripts/reverse_shell/reverse_shell_movement.zeek

# Start Wazuh + Zeek
@load custom_scripts/start.zeek

# Test debug
# @load custom_scripts/reverse_shell/test_debug.zeek
